...
int determinant(int matrix[MAX_ROWS][MAX_COLS], int size) {
    ...
    for (int col = 0; col < size; col++) {
        ...
        // Add or subtract based on the column index
        if (col % 2 == 0) {
...
void coFactor(int mat[MAX_ROWS][MAX_COLS], int cof[MAX_ROWS][MAX_COLS], int n) {
    int temp[MAX_ROWS][MAX_COLS]; // Temporary matrix for submatrices
    for (int a = 0; a < n; a++) {
        for (int b = 0; b < n; b++) {
            int subi = 0; // Index for submatrix row
            for (int x = 0; x < n; x++) {
    ...
    do {
        ...
        switch (opr) {
            ...
            case 2:
                ...
                printMatrix(rows, cols, mat1); // Print matrix immediately after input
                inputMatrix(rows, cols, mat2);
                printMatrix(rows, cols, mat2); // Print matrix immediately after input
            ...
            case 4:
                ...
                inputMatrix(n, n, mat);
                printMatrix(n, n, mat); // Print matrix immediately after input
                coFactor(mat, cof, n);
            ...
            case 5:
                ...
                printMatrix(n, n, matDet); // Print matrix immediately after input
            ...
            case 6:
                ...
                printMatrix(n, n, matInv); // Print matrix immediately after input
                int detInv = determinant(matInv, n); // Compute determinant first
